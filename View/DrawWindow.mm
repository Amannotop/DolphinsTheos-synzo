           ...
           if (self.moduleControl->playerSwitch.SCWZStatus) {
            ...
            if (self.moduleControl->playerSwitch.SCStatus) {
                ...
                if (self.moduleControl->playerSwitch.boxStatus) {
                    if (playerData.hp<=1){
                    imDrawList->AddRect({playerData.screen.x - playerData.size.x, playerData.screen.y - playerData.size.y}, {playerData.screen.x + playerData.size.x, playerData.screen.y + playerData.size.y}, ImColor(255,165,0), 0, 0, 2.0f);
                }else{
